...
def sendEmail(to, content):
    ...
    server.ehlo()
    server.starttls()
    server.login('progadgets2101@gmail.com', 'boo2101$')
...
if _name_ == "_main_":
    ...
    #logic for executing tasks based on query
        ...
        if 'open youtube' in query:
            ...
            speak("I have been created by Surendar.")
            ...
            speak("Thanks to Surendar. further It's a secret")

        elif 'is love' in query:
            speak("It is 7th sense that destroy all other senses")

        elif "who are you" in query:
            speak("I am your virtual assistant created by Surendar")

        elif 'reason for creating you' in query:
            speak("I was created as a Minor project by Mister Surendar ")
